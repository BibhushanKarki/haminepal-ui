    ...
    <>
      ...
      <div className="container">
        <div className="page-header mb-4">
          <h1 className="text-center" id="timeline">
            <u>Milestones</u>
          </h1>
        </div>
        <ul className="timeline">
          <li>
            ...
            <div className="timeline-panel">
              ...
              <div className="timeline-body">
                <p>
                  Shortly after, while the nation hadn’t even completely
                  recovered from earthquake situation, Nepal faced another
                  catastrophe. India blocked its borders with Nepal causing
                  shortage of petroleum, LPG and rations. HamiNepal again worked
                  together at such time to serve people.
                </p>
                <hr />
              </div>
            </div>
          ...
          <li className="timeline-inverted">
            ...
            <div className="timeline-panel">
              ...
              <div className="timeline-body">
                <p>
                  Provided mental health campaigns in a bid to aware people
                  about mental health.
                </p>
              </div>
            </div>
              ...
              <div className="timeline-heading">
                ...
                <p>
                  <small className="text-muted">
                    <i className="fa fa-clock-o"></i> 1 year ago
                  </small>
                </p>
              </div>
              <div className="timeline-body">
                <p>
                  Made houses for those who lost their properties due to the
                  earthquake in several parts of Nepal.
                </p>
              </div>
            </div>
          </li>
